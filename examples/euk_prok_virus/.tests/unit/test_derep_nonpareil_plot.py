...
def test_derep_nonpareil_plot(conda_prefix):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        expected_path = Path(".tests/unit/derep_nonpareil_plot/expected")
        ...
        check_output(
            [
                ...
                "-m",
                "snakemake",
                "reports/reads/nonpareil/merge_lanes/Lib_LVsim1_collapsed.pdf",
                "stats/reads/nonpareil/merge_lanes/Lib_LVsim1_collapsed.tsv",
                "stats/reads/nonpareil/merge_lanes/Lib_LVsim1_collapsed.json",
                "--snakefile",
                "../../workflow/Snakefile",
                "-f",
                "--notemp",
