    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        check_output(
            [
                ...
                "-m",
                "snakemake",
                "stats/reads/nonpareil/merge_lanes/Lib_LVsim1_collapsed.npo",
                "stats/reads/nonpareil/merge_lanes/Lib_LVsim1_collapsed.npa",
                "stats/reads/nonpareil/merge_lanes/Lib_LVsim1_collapsed.npc",
                "stats/reads/nonpareil/merge_lanes/Lib_LVsim1_collapsed.log",
                "--snakefile",
                "../../workflow/Snakefile",
                "-f",
                "--notemp",
