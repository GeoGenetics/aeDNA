...
def test_derep_nonpareil_infer(conda_prefix):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        expected_path = Path(".tests/unit/derep_nonpareil_infer/expected")
        ...
        check_output(
            [
                ...
                "-m",
                "snakemake",
                "stats/reads/nonpareil/merge_lanes/HD827sonic_1_lib1_collapsed.npo",
                "stats/reads/nonpareil/merge_lanes/HD827sonic_1_lib1_collapsed.npa",
                "stats/reads/nonpareil/merge_lanes/HD827sonic_1_lib1_collapsed.npc",
                "stats/reads/nonpareil/merge_lanes/HD827sonic_1_lib1_collapsed.log",
                "--snakefile",
                "../../workflow/Snakefile",
                "-f",
                "--notemp",
